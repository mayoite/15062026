...
describe("plannerSaves repository wrappers", () => {
  ...
  it("saves and surfaces persistence failures", async () => {
    ...
    const saved = await savePlannerDocumentToStore(document, { userId: "00000000-0000-0000-0000-000000000002", saveId: "00000000-0000-0000-0000-000000000006" });
    ...
    await expect(savePlannerDocumentToStore(document, { userId: "00000000-0000-0000-0000-000000000002" })).rejects.toThrow();
  });
  ...
  it("loads documents and maps NOT_FOUND to null", async () => {
    ...
    await expect(loadPlannerDocumentFromStore("00000000-0000-0000-0000-000000000006", "00000000-0000-0000-0000-000000000002")).resolves.toEqual(document);
    ...
    await expect(loadPlannerDocumentFromStore("00000000-0000-0000-0000-000000000006")).rejects.toThrow(/db down/);
  });
  ...
  it("lists summaries and returns empty without userId", async () => {
    ...
    vi.spyOn(plannerPersistenceMod, "listPlannerDocuments").mockResolvedValue({
      success: true,
      documents: [{ id: "00000000-0000-0000-0000-000000000006", document }],
    });
    const rows = await listPlannerDocumentsFromStore({ ownerUserId: "00000000-0000-0000-0000-000000000002" });
  ...
  it("deletes documents via persistence", async () => {
    ...
    await expect(deletePlannerDocumentFromStore("00000000-0000-0000-0000-000000000006")).resolves.toBe(true);
  });

  it("exposes backwards-compatible Supabase aliases", async () => {
    vi.spyOn(plannerPersistenceMod, "savePlannerDocument").mockResolvedValue({ success: true, id: "00000000-0000-0000-0000-000000000006", document } as never);
    vi.spyOn(plannerPersistenceMod, "loadPlannerDocument").mockResolvedValue({ success: true, document } as never);
    vi.spyOn(plannerPersistenceMod, "listPlannerDocuments").mockResolvedValue({ success: true, documents: [{ id: "00000000-0000-0000-0000-000000000006", document }] } as never);
    vi.spyOn(plannerPersistenceMod, "deletePlannerDocument").mockResolvedValue({ success: true } as never);

    await savePlannerDocumentToSupabase(document, { userId: "00000000-0000-0000-0000-000000000002" });
    await loadPlannerDocumentFromSupabase("00000000-0000-0000-0000-000000000006");
    await listPlannerDocumentsFromSupabase({ userId: "00000000-0000-0000-0000-000000000002" });
    await deletePlannerDocumentFromSupabase("00000000-0000-0000-0000-000000000006");
