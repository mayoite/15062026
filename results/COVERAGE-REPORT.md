...
Regenerate: `npm run docs:sync:coverage` · Source: `results/coverage-summary.json` · **2026-06-15T15:36:03.878Z**

## Executive summary

| Track | Scope | Statements | Functions | Branches | Lines | Gate target | CI threshold | Status |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Planner | `features/planner/**` | 78.6% (9707/12356) | 75.3% (2301/3054) | 69.8% (5972/8556) | 80.5% (8797/10927) | 75% | 20 / 21 / 20 / 21 (statements / functions / branches / lines) | At or above product target |
...
5. **59 / 314** planner files and **0 / 71** site files have **0% statements** — target large zero-coverage modules first.
6. Product targets (75% planner / 50% site) are **not** CI thresholds yet; see `plans/MASTER-PLAN.md` critical path.

## Planner track

**Files in scope:** 314 · **Zero-statement files:** 59

### Rollup by metric

| Metric | Covered / Total | % | Target | Remarks |
| --- | --- | --- | --- | --- |
| Statements | 9707 / 12356 | 78.6% | 75% | 78.6% — near or above target; maintain on new code. 59 file(s) at 0% statements in this bucket. |
| Functions | 2301 / 3054 | 75.3% | 75% | 75.3% — good function reach; watch thin wrappers re-exporting untested deps. |
| Branches | 5972 / 8556 | 69.8% | 75% | 69.8% — strong branch coverage; keep edge-case tables in tests. |
| Lines | 8797 / 10927 | 80.5% | 75% | 80.5% — aligns with Vitest `lines` CI threshold; keep new code on green paths. |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `store/` | 95.7% (1788/1868) | 96.6% (661/684) | 85.9% (1009/1174) | 96.5% (1539/1594) | 45 | 0 | Near target — protect with threshold ratchet. |
| `hooks/` | 98.4% (793/806) | 99.2% (125/126) | 91.6% (435/475) | 99.5% (734/738) | 5 | 0 | Near target — protect with threshold ratchet. |
| `tldraw/` | 89.8% (2094/2332) | 90% (415/461) | 78.6% (1105/1406) | 91.7% (1950/2127) | 45 | 0 | Near target — protect with threshold ratchet. |
...
| `editor/` | 87.7% (1753/1999) | 90.4% (426/471) | 78% (1224/1570) | 90.2% (1605/1779) | 42 | 0 | Near target — protect with threshold ratchet. |
| `lib/` | 95% (1489/1567) | 98.6% (272/276) | 85.1% (823/967) | 97.8% (1346/1376) | 29 | 0 | Near target — protect with threshold ratchet. |
| `catalog/` | 97.7% (673/689) | 96.5% (166/172) | 85.5% (485/567) | 98.5% (581/590) | 21 | 0 | Near target — protect with threshold ratchet. |
| `persistence/` | 42.6% (229/538) | 31.8% (35/110) | 44.6% (139/312) | 46.7% (219/469) | 7 | 2 | Already partially covered — extend existing test files. |
| `shared/` | 50.7% (238/469) | 32.5% (39/120) | 34.3% (147/428) | 54.7% (226/413) | 34 | 8 | Already partially covered — extend existing test files. |
