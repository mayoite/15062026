...
INSERT INTO products (name, slug, category, category_id, flagship_image, description, scene_images, variants, detailed_info, metadata, specs, series_id, series_name) 
VALUES ('DMRC Office', 'project-dmrc', 'projects', 'projects', '/images/projects/DMRC/dmrc-facility.webp', 'Office setup for Delhi Metro Rail Corporation.', ARRAY[]::text[], '[]'::jsonb, '{}'::jsonb, '{"price":"Project","tags":[]}'::jsonb, '{"dimensions":"","materials":[],"features":["Large Scale","Government"],"location":"Delhi"}'::jsonb, 'projects-series', 'Projects Series') 
ON CONFLICT (slug) DO UPDATE SET 
    name = EXCLUDED.name,
    category = EXCLUDED.category,
    category_id = EXCLUDED.category_id,
