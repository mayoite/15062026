 ...
 * card on a soft gradient with the Buddycraft wordmark up top — the
...
export function AuthShell({
   ...
   * "Create account". The shell appends "— Buddycraft" so the
  ...
  useDocumentTitle(documentTitle ? `${documentTitle} — Buddycraft` : null)
  return (
