...
const consentBarClass =
  "fixed inset-x-0 bottom-0 z-30 border-t border-soft surface-overlay-95 backdrop-blur [box-shadow:0_-18px_40px_-30px_var(--overlay-inverse-35)] [animation:consent-slide-in_0.32s_cubic-bezier(0.22,1,0.36,1)_both] motion-reduce:[animation:none]";
