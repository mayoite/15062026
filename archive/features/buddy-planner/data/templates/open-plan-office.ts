...
function makeDesk(x: number, y: number, index: number, zIndex: number): DeskElement {
  return {
    ...
    label: 'Desk',
    visible: true,
    style: { fill: 'var(--border-soft)', stroke: 'var(--border-soft)', strokeWidth: 2, opacity: 1 },
...
export function createOpenPlanOfficeTemplate(): CanvasElement[] {
  ...
  const confRoom1: ConferenceRoomElement = {
    ...
    visible: true,
    style: { fill: 'var(--surface-panel)', stroke: 'var(--color-primary)', strokeWidth: 2, opacity: 1 },
  ...
  const phoneBooth1: PhoneBoothElement = {
    ...
    label: 'Phone Booth 1',
    visible: true,
    style: { fill: 'var(--surface-panel)', stroke: 'var(--border-soft)', strokeWidth: 2, opacity: 1 },
  }
  ...
  elements.push({
    ...
    label: 'Divider',
    visible: true,
    style: { fill: 'var(--surface-panel)', stroke: 'var(--border-soft)', strokeWidth: 1, opacity: 1 },
  })
  ...
  elements.push({
    ...
    label: 'Planter',
    visible: true,
    style: { fill: 'var(--border-soft)', stroke: 'var(--color-success)', strokeWidth: 1, opacity: 1 },
  })
