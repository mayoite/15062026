...
export function FirstUseTooltip({
  ...
  return (
    ...
    >
      <div className="bg-gray-900 text-white rounded-lg shadow-soft p-3 text-ui-11 leading-snug border border-gray-800">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="font-semibold text-ui-13">{name}</span>
          {shortcut && (
            <kbd
