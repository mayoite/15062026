...
function CalibrateScaleModalBody() {
  ...
  return (
    <Modal open onClose={reset} title="Set scale" size="sm">
      <ModalBody>
        <p className="text-ui-11 text-gray-500 dark:text-gray-400 mb-3">
        ...
        <div className="flex gap-2">
          <div className="flex-1">
            <label className="block text-ui-11 text-gray-700 dark:text-gray-200 mb-1" htmlFor="calibrate-distance">
              Distance
            </label>
            <input
              ...
              className="w-full text-ui-13 border border-[color:var(--color-paper-line)] dark:border-gray-800 rounded px-2 py-1 focus:outline-none focus:border-[color:var(--color-blueprint)]"
            />
          </div>
          <div className="w-24">
            <label className="block text-ui-11 text-gray-700 dark:text-gray-200 mb-1" htmlFor="calibrate-unit">
              Unit
            </label>
            <select
              id="calibrate-unit"
        ...
        {error && (
          <p
            ...
            className="text-ui-11 text-red-600 dark:text-red-400 mt-1"
            role="alert"
          >
            {error}
          </p>
