...
// eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  return (
    <div
      ...
      className="fixed z-50 min-w-[200px] py-1 rounded-md border border-[color:var(--color-paper-line)] bg-[color:var(--color-paper-raised)] shadow-soft dark:border-gray-700 dark:bg-gray-900 dark:shadow-black/40"
          ...
          {group.items.map((item) => {
            ...
            return (
              <button
                ...
                className="flex w-full items-center gap-2 px-3 py-1.5 text-left text-ui-13 text-gray-700 hover:bg-[color:var(--color-paper-sunken)] focus:bg-[color:var(--color-paper-sunken)] focus:outline-none focus-visible:ring-1 focus-visible:ring-[color:var(--color-blueprint)] dark:text-gray-200 dark:hover:bg-gray-800/60 dark:focus:bg-gray-800/60"
              >
