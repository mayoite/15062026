...
export function NewVersionBanner() {
  ...
  return (
    <div
      ...
      className="fixed top-0 inset-x-0 z-[60] flex items-center gap-2 px-3 py-2 sm:px-4 bg-[color:var(--color-blueprint-strong)] text-white text-ui-13 shadow-md"
    >
      <RefreshCw size={14} aria-hidden="true" className="shrink-0" />
      <p className="flex-1 truncate">
        A new version of Buddycraft is available.{' '}
        {isSaving ? (
      ...
      <button
        ...
        disabled={isSaving}
        className="inline-flex items-center gap-1 rounded bg-white/15 hover:bg-white/25 disabled:opacity-50 disabled:cursor-not-allowed px-2 py-1 text-ui-11 font-semibold transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-white"
