  ...
  const panel = (
    ...
    >
      <div
        ...
        tabIndex={-1}
        className={cn(
          'modal-panel-enter bg-[color:var(--color-paper-raised)] dark:bg-gray-900 rounded-lg shadow-soft dark:shadow-soft dark:shadow-black/40 w-full outline-none max-h-[90vh] overflow-y-auto',
          SIZE_CLASS[size],
        )}
      >
        {title ? (
