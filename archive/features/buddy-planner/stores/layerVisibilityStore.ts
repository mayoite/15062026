...
export type LayerCategory =
  ...
  | 'underlay'
  // Annotation drawing primitives (rect, ellipse, line, arrow, free-text).
  // Separate from 'furniture' so markup can be toggled independently.
  | 'annotations'
  // IT/AV/Network/Power infrastructure (M2). Covers access-points,
  // network jacks, displays, video bars, badge readers, outlets.
  | 'it-device'
