...
interface ProjectState {
  ...
  saveState: SaveState
  // In-flight save mutex. `useOfficeSync` flips this on before touching
  // Supabase so the optimistic retry loop and the manual overwrite path
  // cannot overlap and issue a second write for the same payload.
  isSaving: boolean
