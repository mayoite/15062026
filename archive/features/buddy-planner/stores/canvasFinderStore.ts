 ...
 * common areas, neighborhoods — and lets the user cycle through
 ...
 * element id on the active floor;
...
export interface FinderMatch {
  kind: 'element' | 'neighborhood'
  /** Stable identifier for the matched record (element id, neighborhood id). */
  id: string
  /** Element id to highlight + focus on. */
  anchorId: string
