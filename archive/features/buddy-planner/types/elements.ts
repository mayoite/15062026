...
export type ElementType =
  ...
  // no neighborhood) and contributes to one of four logical
...
export interface BaseElement {
  ...
  zone?: string
  style: ElementStyle
  // For mapping to actual sellable catalog products (Phase 3 migration bridge)
  productId?: string
  variantId?: string
  // Vertical elevation from the floor in millimeters
  z?: number
}
...
export interface DeskElement extends BaseElement {
  type: 'desk' | 'hot-desk'
  shape?: 'straight' | 'l-shape' | 'cubicle'
  deskId: string
  /** Optional capacity override — legacy compat. */
  capacity?: number
}
...
export interface PrivateOfficeElement extends BaseElement {
  type: 'private-office'
  shape?: 'rectangular' | 'u-shape'
  deskId: string
  /** Max occupancy — optional for legacy compatibility. */
  capacity?: number
}
...
export interface ConferenceRoomElement extends BaseElement {
  ...
  roomName: string
  /** Seating capacity — optional for legacy compatibility. */
  capacity?: number
}
...
export interface LoungeChairElement extends BaseElement { type: 'lounge-chair' }
export interface CoffeeTableElement extends BaseElement { type: 'coffee-table' }
export interface FileCabinetElement extends BaseElement { type: 'file-cabinet' }
export interface StorageCabinetElement extends BaseElement { type: 'storage-cabinet' }
export interface LockerElement extends BaseElement { type: 'locker' }
export interface VendingMachineElement extends BaseElement { type: 'vending-machine' }
export interface WaterCoolerElement extends BaseElement { type: 'water-cooler' }
export interface AcousticPodElement extends BaseElement { type: 'acoustic-pod' }
export interface CredenzaElement extends BaseElement { type: 'credenza' }
export interface CoatRackElement extends BaseElement { type: 'coat-rack' }
...
export type CanvasElement =
  ...
  | CoffeeTableElement
  | FileCabinetElement
  | StorageCabinetElement
  | LockerElement
  | VendingMachineElement
  | WaterCoolerElement
  | AcousticPodElement
  | CredenzaElement
  | CoatRackElement
...
export function isLoungeChairElement(el: CanvasElement): el is LoungeChairElement {
  return el.type === 'lounge-chair'
}

export function isCoffeeTableElement(el: CanvasElement): el is CoffeeTableElement {
  return el.type === 'coffee-table'
}

export function isFileCabinetElement(el: CanvasElement): el is FileCabinetElement {
  return el.type === 'file-cabinet'
}

export function isStorageCabinetElement(el: CanvasElement): el is StorageCabinetElement {
  return el.type === 'storage-cabinet'
}

export function isLockerElement(el: CanvasElement): el is LockerElement {
  return el.type === 'locker'
}

export function isVendingMachineElement(el: CanvasElement): el is VendingMachineElement {
  return el.type === 'vending-machine'
}

export function isWaterCoolerElement(el: CanvasElement): el is WaterCoolerElement {
  return el.type === 'water-cooler'
}

export function isAcousticPodElement(el: CanvasElement): el is AcousticPodElement {
  return el.type === 'acoustic-pod'
}

export function isCredenzaElement(el: CanvasElement): el is CredenzaElement {
  return el.type === 'credenza'
}

export function isCoatRackElement(el: CanvasElement): el is CoatRackElement {
  return el.type === 'coat-rack'
}
